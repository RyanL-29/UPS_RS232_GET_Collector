...
WA = UPSNMC_Data_Fetching_Info(
        ...
        parse_rules=[
            ...
            UPSNMC_Reply_Data_Parse_Rules(key="load_total_watt", start_index=36, length=5, data_type="float"),
            UPSNMC_Reply_Data_Parse_Rules(key="load_total_va", start_index=42, length=5, data_type="float"),
            UPSNMC_Reply_Data_Parse_Rules(key="output_current_1", start_index=48, length=5, data_type="float"),
            UPSNMC_Reply_Data_Parse_Rules(key="output_current_2", start_index=54, length=5, data_type="float"),
            UPSNMC_Reply_Data_Parse_Rules(key="output_current_3", start_index=60, length=5, data_type="float"),
